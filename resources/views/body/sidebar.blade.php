            ...
            @if(Auth()->user()->is_admin == 1)
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('users.index')}}">Afiseaza</a></li>
                        <li><a href="{{route('users.create')}}">Adauga</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('appointments.index')}}">Afiseaza</a></li>
                        <li><a href="{{route('appointments.create')}}">Adauga</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('teachers.index')}}">Afiseaza</a></li>
                        <li><a href="{{route('teachers.add-edit')}}">Adauga</a></li>
                    </ul>
                </li>
            @else
                <li>
                    <a href="{{route('user.myProfile')}}" class=" waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('appointments.my')}}">Programarile mele</a></li>
                        <li><a href="{{route('appointments.indexClient')}}">Programeaza sedinta</a></li>
                    </ul>
                </li>
            @endif
            <!-- <li>
